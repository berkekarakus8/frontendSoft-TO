...
export default function Header({ setView, searchInput, setSearchInput, handleSearchSubmit, setSelectedCategory, setSearchQuery, onLoginClick, onCartClick, cartCount }) {
