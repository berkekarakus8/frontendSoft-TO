      ...
      <main className="container">
        <div className="form-layout">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group">
              <label className="form-label">Acıklama</label>
              <textarea
                className="form-textarea"
                placeholder="Ürün Detayları..."
                {...register('description',{
                    required:'Acıklama zorunludur',
                    minLength:{
                        value:10,
                        message:'Acıklama en az 10 karakter olmalıdır'
                    }
                })}
              />
                {errors.description &&(
            ...
            <span className='form-toggle-btn' onClick={()=>{reset();setView('home')}}>Geri Don</span>
          </form>
        </div>
      </main>
    </>
